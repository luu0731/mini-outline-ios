...
public let tunWriteQueue = DispatchQueue(label: "mini.tun.write", qos: .userInteractive)
public let tunReadQueue = DispatchQueue(label: "mini.tun.read", qos: .userInteractive)
...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    // Continuously read IP packets from TUN and input to outline.
    func handlePackets() {
